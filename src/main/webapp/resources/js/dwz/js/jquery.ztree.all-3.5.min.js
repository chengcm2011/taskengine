...
(function (k) {
    ...
    k.fn.zTree = {
        consts: {
            ...
            id: {
                A: "_a", ICON: "_ico", SPAN: "_span",
                SWITCH: "_switch", UL: "_ul"
            },
...
(function (m) {
            ...
            getRadioCheckedList: function (c) {
                ...
                if (a) {
                    ...
                    if (a[b])for (var e = !1, h = 0, i = a[b].length; h < i; h++) {
                        var f = a[b][h], k = -1;
                        if (c.check.chkStyle ==
                            j.radio.STYLE)if (k = f.nocheck === !0 ? f.check_Child_State : f.halfCheck === !0 ? 2 : f.nocheck !== !0 && f[d] ? 2 : f.check_Child_State > 0 ? 2 : 0, k == 2) {
                            g = 2;
                            break
    ...
    f.addInitNode(function (c, a, b, d) {
        if (b) {
            ...
            b.nocheck =
                !!b.nocheck || c.check.nocheckInherit && d && !!d.nocheck;
        ...
        onHoverOverNode: function (b, a) {
            ...
            function c(b) {
                ...
                if (z.dragFlag == 1) {
                    ...
                    var s = o < g.edit.drag.borderMax && o > g.edit.drag.borderMin, I = n < g.edit.drag.borderMax && n > g.edit.drag.borderMin, C = H < g.edit.drag.borderMax && H > g.edit.drag.borderMin, o = c > g.edit.drag.borderMin && o > g.edit.drag.borderMin && n > g.edit.drag.borderMin && H > g.edit.drag.borderMin, n = l && i.treeObj.scrollTop() <= 0, H = s && i.treeObj.scrollTop() + i.treeObj.height() + 10 >= a, M = I && i.treeObj.scrollLeft() <= 0, N = C && i.treeObj.scrollLeft() + i.treeObj.width() + 10 >= f;
                ...
                if (z.dragFlag != 0) {
                    ...
                    if (r) {
                        ...
                        if (h.apply(g.callback.beforeDrop, [i.treeId, m, n, v, o], !0) != !1) {
                            ...
                            a = function () {
                                if (G) {
                                    if (!o)for (var b = 0, a = m.length; b < a; b++)e.removeNode(g, m[b]);
                                    if (v == d.move.TYPE_INNER)e.addNodes(i,
                                        n, s); else if (e.addNodes(i, n.getParentNode(), s), v == d.move.TYPE_PREV)for (b = 0, a = s.length; b < a; b++)e.moveNode(i, n, s[b], v, !1); else for (b = -1, a = s.length - 1; b < a; a--)e.moveNode(i, n, s[a], v, !1)
                                } else if (o && v == d.move.TYPE_INNER)e.addNodes(i, n, s); else if (o && e.addNodes(i, n.getParentNode(), s), v != d.move.TYPE_NEXT)for (b = 0, a = s.length; b < a; b++)e.moveNode(i, n, s[b], v, !1); else for (b = -1, a = s.length - 1; b < a; a--)e.moveNode(i, n, s[a], v, !1);
    ...
    k.extend(!0, k.fn.zTree._z, {
        tools: {
            ...
            addEditBtn: function (b, a) {
                ...
                if (c !== a.level) {
                    var b = k("#" + a.tId), e = k("#" + a.tId + d.id.A), f = k("#" + a.tId + d.id.UL), c = "level" + c, a = "level" + a.level;
                    b.removeClass(c);
                    b.addClass(a);
                    e.removeClass(c);
                    e.addClass(a);
