            ...
            <div class="accordion" fillSpace="sidebar">
                ...
                <div class="accordionContent">
                    <ul class="tree treeFolder">
                        <li><a href="management/task/index?rel=taskregister" target="navTab" rel="taskregister">任务注册</a>
                        </li>
                        <li><a href="management/task/deploy/index?rel=taskdeploy" target="navTab"
                               rel="taskdeploy">任务部署</a></li>
                        <li><a href="management/task/status/index?rel=taskstatus" target="navTab"
                               rel="taskdeploy">任务状态</a></li>
...
<div id="footer">Copyright &copy; 2015 <a href="http://www.chengyingsheng.com" target="dialog">cheng</a>&nbsp;&nbsp;&nbsp;&nbsp;http://www.chengyingsheng.com
</div>
</body>
</html>