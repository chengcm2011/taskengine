...
<div class="panelBar">
	<ul class="toolBar">
       ...
       <li class="line">line</li>
		...
		<li class="line">line</li>
		<li><a class="edit" href="management/task/deploy/start?pk={pk}" target="ajaxTodo" title="确定要启动吗？" rel="start"><span>启动</span></a></li>
		<li class="line">line</li>
		<li><a class="edit" href="management/task/deploy/stop?pk={pk}" target="ajaxTodo" title="确定要停止吗？"  rel="stop"><span>停止</span></a></li>
		<li class="line">line</li>
		<%--<li><a class="edit" href="management/task/deploy/pause?pk={pk}" target="ajaxTodo" title="确定要暂停吗？"  rel="pause"><span>暂停</span></a></li>--%>
		<%--<li class="line">line</li>--%>
	        ...
	        <c:forEach var="item" items="${pageVO.data }" varStatus="sta">
	          <tr target="pk" rel="${item.id_taskdeploy }">
	            ...
	            <td>${item.taskname }</td>
				  ...
				  <td><c:if test="${'Y' eq item.runnable }">运行中</c:if><c:if test="${'N' eq item.runnable }">已停止</c:if></td>
	          </tr>
	        </c:forEach>
	      </c:if>
      </tbody>
