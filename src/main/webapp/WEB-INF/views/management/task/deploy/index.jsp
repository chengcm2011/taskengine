...
<div class="tabs">
    ...
    <div class="tabsContent">
        <form rel="pagerForm" onsubmit="return navTabSearch(this);" class=" pageForm required-validate"
              action="management/task/deploy/index#taskdeploy" method="post">
            <div class="searchBar">
                <ul class="searchContent">
                    <li>
                        ...
                        <a class="btnLook"
                           href="management/uicomponent/ref/index?reftype=taskplugin&itemkey=pkTaskplugin"
...
<div class="panelBar">
    <ul class="toolBar">
        ...
        <li><a class="edit" href="management/task/deploy/edit?pk={pk}" target="dialog"
               rel="updateplugin"><span>修改</span></a></li>
        <li class="line">line</li>
        <li><a class="delete" href="management/task/deploy/del?pk={pk}" target="ajaxTodo" title="确定要删除吗？"
               rel="del"><span>删除</span></a></li>
        <li class="line">line</li>
        <li><a class="delete" href="management/task/deploy/disable?pk={pk}" target="ajaxTodo" title="确定要禁用吗？"
               rel="disable"><span>禁用</span></a></li>
        <li class="line">line</li>
...
<div class="pageContent">
    ...
    <div class="panelBar">
        ...
        <div class="pagination" targetType="navTab" totalCount="${pageVO.totalCount }" numPerPage="${pageVO.pageSize }"
             pageNumShown="10" currentPage="${pageVO.pageNum}"></div>
    </div>
