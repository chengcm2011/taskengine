...
<div class="tabs">
    ...
    <div class="tabsContent">
        <form rel="pagerForm" onsubmit="return navTabSearch(this);" class=" pageForm required-validate"
              action="management/task/paramkey/index?pk=${pk}" method="post">
            <div class="searchBar">
...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="edit" href="management/task/paramvalue/edit?pkTaskdeploy=${pk}&pk={pk}"
    ...
    <table class="table" width="100%" layoutH="165" nowrapTD="false">
        ...
        <c:if test="${not empty pageVO.data }">
            <c:forEach var="item" items="${pageVO.data }" varStatus="sta">
                <tr target="pk" rel="${item.pkTaskparamkey };${pk}">
